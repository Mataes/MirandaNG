...
static void IdleObject_ReadSettings(IdleObject * obj)
{
	...
	obj->aastatus = !db_get_b(NULL, IDLEMOD, IDL_AAENABLE, 1) ? 0 : DBGetContactSettingWord(NULL, IDLEMOD, IDL_AASTATUS, 40075);
	...
	if ( db_get_b(NULL, IDLEMOD, IDL_IDLEONSAVER, 1)) IdleObject_SetSaverCheck(obj);
	if ( db_get_b(NULL, IDLEMOD, IDL_IDLEONFULLSCR, 1)) IdleObject_SetFullScrCheck(obj);
	if ( db_get_b(NULL, IDLEMOD, IDL_IDLEONLOCK, 1)) IdleObject_SetWorkstationCheck(obj);
...
static INT_PTR CALLBACK IdleOptsDlgProc(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_INITDIALOG:
	{
		...
		CheckDlgButton(hwndDlg, IDC_SCREENSAVER, db_get_b(NULL, IDLEMOD, IDL_IDLEONSAVER, 1) ? BST_CHECKED : BST_UNCHECKED);
		CheckDlgButton(hwndDlg, IDC_FULLSCREEN, db_get_b(NULL, IDLEMOD, IDL_IDLEONFULLSCR, 1) ? BST_CHECKED : BST_UNCHECKED);
		CheckDlgButton(hwndDlg, IDC_LOCKED, db_get_b(NULL, IDLEMOD, IDL_IDLEONLOCK, 1) ? BST_CHECKED : BST_UNCHECKED);
		...
		CheckDlgButton(hwndDlg, IDC_AASHORTIDLE, db_get_b(NULL, IDLEMOD, IDL_AAENABLE, 1) ? BST_CHECKED:BST_UNCHECKED);
		...
		j = IdleGetStatusIndex((WORD)(DBGetContactSettingWord(NULL, IDLEMOD, IDL_AASTATUS, 40075)));
