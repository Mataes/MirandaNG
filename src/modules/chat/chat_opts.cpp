...
static FontOptionsList fontOptionsList[] =
{
	...
	{ _T(""),                                 RGB(0, 0, 40),      lfDefault.lfFaceName, DEFAULT_CHARSET, 0, -13 },
	{ LPGENT("Nick list members (online)"),   RGB(0, 0, 0),       lfDefault.lfFaceName, DEFAULT_CHARSET, 0, -13 },
	{ LPGENT("Nick list members (away)"),     RGB(170, 170, 170), lfDefault.lfFaceName, DEFAULT_CHARSET, 0, -13 },
};
...
void LoadGlobalSettings(void)
{
	...
	g_Settings->bLoggingEnabled = (BOOL)db_get_b(NULL, CHAT_MODULE, "LoggingEnabled", 1) != 0;
	...
	g_Settings->iPopupStyle = db_get_b(NULL, CHAT_MODULE, "PopupStyle", 2);
	g_Settings->iPopupTimeout = db_get_w(NULL, CHAT_MODULE, "PopupTimeout", 0);
