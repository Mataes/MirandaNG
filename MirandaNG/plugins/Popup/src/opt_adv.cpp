...
void LoadOption_AdvOpts() {
	//History
	PopUpOptions.EnableHistory			= DBGetContactSettingByte (NULL,MODULNAME, "EnableHistory", 0);
	...
	PopUpOptions.EnableAvatarUpdates	= DBGetContactSettingByte (NULL,MODULNAME, "EnableAvatarUpdates", 1);
	//Monitor
	...
	PopUpOptions.Alpha					= DBGetContactSettingByte (NULL,MODULNAME, "Alpha", 255);
