...
void InitFonts()
{
	...
	_tcscpy(fontTitle.deffontsettings.szFace, _T("Verdana"));
	fontTitle.deffontsettings.charset = DEFAULT_CHARSET;
	fontTitle.deffontsettings.size = -16;
	...
	_tcscpy(fontLabels.deffontsettings.szFace, _T("Verdana"));
	fontLabels.deffontsettings.charset = DEFAULT_CHARSET;
	fontLabels.deffontsettings.size = -11;
	fontLabels.deffontsettings.style = DBFONTF_BOLD;
	...
	_tcscpy(fontValues.deffontsettings.szFace, _T("Verdana"));
	fontValues.deffontsettings.charset = DEFAULT_CHARSET;
	fontValues.deffontsettings.size = -11;
	...
	fontTrayTitle.deffontsettings.size = -13;
