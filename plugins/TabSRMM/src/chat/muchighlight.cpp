...
void CMUCHighlight::init()
{
	...
	m_dwFlags = M.GetByte(CHAT_MODULE, "HighlightEnabled", MATCH_TEXT | MATCH_NICKNAME | MATCH_UIN);
...
INT_PTR CALLBACK CMUCHighlight::dlgProc(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_INITDIALOG:
		TranslateDialogDefault(hwndDlg);
		{
			...
			DWORD dwFlags = M.GetByte(CHAT_MODULE, "HighlightEnabled", MATCH_TEXT | MATCH_NICKNAME | MATCH_UIN);
