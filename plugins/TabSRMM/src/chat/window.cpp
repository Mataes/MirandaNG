	...
	case WM_INITDIALOG:
		{
			...
			DWORD dwFlags = db_get_dw(si->hContact, "Chat", "FilterFlags", GC_EVENT_ACTION | GC_EVENT_MESSAGE | GC_EVENT_NICK | GC_EVENT_TOPIC | GC_EVENT_ADDSTATUS | GC_EVENT_INFORMATION | GC_EVENT_QUIT | GC_EVENT_KICK | GC_EVENT_NOTICE);

			DWORD dwPopupMask = db_get_dw(si->hContact, "Chat", "PopupMask", 0);
			DWORD dwPopupFlags = db_get_dw(si->hContact, "Chat", "PopupFlags", GC_EVENT_KICK | GC_EVENT_HIGHLIGHT);

			DWORD dwTrayMask = db_get_dw(si->hContact, "Chat", "TrayIconMask", 0);
			DWORD dwTrayFlags = db_get_dw(si->hContact, "Chat", "TrayIconFlags", GC_EVENT_KICK | GC_EVENT_HIGHLIGHT);
