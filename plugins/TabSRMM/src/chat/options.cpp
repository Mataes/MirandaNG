...
void LoadGlobalSettings(void)
{
	...
	g_Settings.LoggingLimit = (size_t)db_get_w(NULL, "Chat", "LoggingLimit", 0);
	g_Settings.bLoggingEnabled = M.GetBool("Chat", "LoggingEnabled", true);
	...
	g_Settings.iPopupTimeout = db_get_w(NULL, "Chat", "PopupTimeout", 0);
	...
	//MAD_
	g_Settings.bLogSymbols = M.GetBool("Chat", "LogSymbols", false);
