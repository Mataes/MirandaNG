...
static INT_PTR CALLBACK OptionsProc(HWND hdlg, UINT msg, WPARAM wparam, LPARAM lparam)
{
	...
	case WM_INITDIALOG:
		TranslateDialogDefault(hdlg);
		{
			...
			SetDlgItemInt(hdlg, IDC_TRACK, g_ses_limit = db_get_b(0, MODNAME, "TrackCount", 1), FALSE);
