...
void LoadOption_General() {
	...
	PopUpOptions.Seconds			= DBGetContactSettingWord(NULL, MODULNAME, "Seconds", 4);
	PopUpOptions.LeaveHovered		= DBGetContactSettingByte(NULL, MODULNAME, "LeaveHovered", TRUE);
	//Dynamic Resize
	PopUpOptions.DynamicResize		= DBGetContactSettingByte(NULL, MODULNAME, "DynamicResize", 1);
	...
	//Position
	PopUpOptions.Position			= DBGetContactSettingByte(NULL, MODULNAME, "Position", 2);
