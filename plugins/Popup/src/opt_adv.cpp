...
{
	//History
	PopupOptions.EnableHistory = db_get_b(NULL, MODULNAME, "EnableHistory", 0);
	...
	PopupOptions.EnableAvatarUpdates = db_get_b(NULL, MODULNAME, "EnableAvatarUpdates", 1);
	...
	PopupOptions.Alpha = db_get_b(NULL, MODULNAME, "Alpha", 255);
