...
#define CLCDEFAULT_EXSTYLE       (CLS_EX_EDITLABELS|CLS_EX_TRACKSELECT|CLS_EX_SHOWGROUPCOUNTS|CLS_EX_TRACKSELECT|CLS_EX_NOSMOOTHSCROLLING|CLS_EX_QUICKSEARCHVISONLY)  //plus CLS_EX_NOSMOOTHSCROLL is got from the system
